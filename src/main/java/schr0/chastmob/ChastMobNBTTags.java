...
public class ChastMobNBTTags
{
	...
	public static final String CHAST_OPEN = ENTITY_CHAST + "open";
	public static final String CHAST_COLOR = ENTITY_CHAST + "color";
	public static final String CHAST_SITTING = ENTITY_CHAST + "sitting";
